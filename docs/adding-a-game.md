...
The production catalogue contains four games, Capital Pin, Falling Platforms,
Flappy Race, and Memory Path. This guide defines the boundaries every additional game must
...
the four installed games established.
...
Platforms, Flappy Race, and Memory Path are the reference implementations: the lobby creates
