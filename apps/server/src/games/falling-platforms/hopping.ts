import type { HopRejectionReason } from "@phone-party/protocol";
import { isAdjacent, parsePlatformId } from "@phone-party/protocol";
...
export function startHop(
  ...
  player.jumpEndsAt = now + runtime.settings.hopDurationMs;
  player.jumping = true;
