...
export function copyPlayer(target: FallingPlatformsPlayerState, source: RuntimePlayer): void {
...
function copyPlatform(
  target: { id: string; gridX: number; gridY: number; state: RuntimePlatform["state"] },
...
export function syncState(state: FallingPlatformsState, runtime: MatchRuntime): void {
