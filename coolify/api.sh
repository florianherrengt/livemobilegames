...
Examples:
  ...
  ./coolify/api.sh GET /applications/l1dggfkxw6q2bs2m79pqkzt2
  ./coolify/api.sh PATCH /applications/l1dggfkxw6q2bs2m79pqkzt2 '{"name":"new-name"}'
  printf '%s\n' '{"name":"new-name"}' | ./coolify/api.sh PATCH /applications/l1dggfkxw6q2bs2m79pqkzt2 -
